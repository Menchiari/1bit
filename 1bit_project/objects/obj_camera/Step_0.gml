...
//{
//	if point_distance(obj_hero.x,obj_hero.y,instance_nearest(obj_hero.x,obj_hero.y,obj_camera_pos).x,instance_nearest(obj_hero.x,obj_hero.y,obj_camera_pos).y)<global_res_x*.4
