if active==true && char_visible==true {
...
//draw character
	...
	&& object_index!=obj_hero
	{
		...
		{
			//strong attack
			if attack_color==true {draw_sprite_ext(sprite_skin,image_index,x,y,dir*size,1*size,char_rot,c_black,.4);}
			if attack_color==false {draw_sprite_ext(sprite_skin,image_index,x,y,dir*size,1*size,char_rot,c_white,.4);}
		}
		else
		{
			//weak attack
			if attack_color==true {draw_sprite_ext(sprite_skin,image_index,x,y,dir*size,1*size,char_rot,c_red,.2);}
			if attack_color==false {draw_sprite_ext(sprite_skin,image_index,x,y,dir*size,1*size,char_rot,c_white,.2);}
		}
	}
}