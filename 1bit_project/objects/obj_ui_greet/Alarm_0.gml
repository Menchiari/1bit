...
{
	mercenary.ai_state_original=ai_states.idle;
	...
	button_pressed=0;
	shop_text="GREET";
	shop_text_cancel="GREET";
	description="You stare at the "+string(name);
...
{
	mercenary=instance_nearest(x,y,obj_mercenary);//mercenary=collision_circle(x,y,10,obj_character,true,true);
	alarm[0]=10;
}