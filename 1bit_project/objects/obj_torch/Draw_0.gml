...
if instance_exists(obj_hero)
{
	...
	draw_sprite_ext(spr_fx_light,0,x/*+body_offsetx-(4*obj_hero.dir)*/,y/*+body_offsety-5+random_range(-1,1)*/,2.6*obj_hero.dir,2.3,random_range(-5,5),c_yellow,clamp((life+random_range(-.05,0)+.5),0,.9));
}
